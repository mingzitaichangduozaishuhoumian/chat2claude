    ...
    <div class="workspace">
      ...
      <div class="modules">
        <section id="authentication-module" class="admin-module" data-module-name="authentication" role="tabpanel" aria-labelledby="authentication-tab">
          ...
          <section id="api-config" class="panel" hidden><h3>API 配置</h3><div class="stack"><p>Endpoint：<code id="endpoint"></code></p><p class="muted">将上方一次性显示的 Runtime API Key 安全保存后，再替换此示例中的占位符。</p><pre id="ready-curl"></pre></div></section>
