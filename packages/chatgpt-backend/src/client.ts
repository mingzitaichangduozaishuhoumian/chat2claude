...
export interface ChatGptBackendClient { complete(request: ChatGptCompletionRequest): Promise<ChatGptCompletionResponse>; stream(request: ChatGptCompletionRequest): AsyncIterable<ChatGptStreamEvent>; }
